...
function BookingList() {
  ...
  const handleCreate = () => {
      const checkInDate = newCheckInDate || formatDate(today);
      const newBooking = {
  ...
  const [newCheckInDate, setNewCheckInDate] = useState(formatDate(today));
  const [newCheckOutDate, setNewCheckOutDate] = useState(formatDate(today));
